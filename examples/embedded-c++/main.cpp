...
// std::vector<std::string> predicate = {"> 9.8"};
// std::vector<std::string> threads = {"1", "2", "5", "10", "20"};
std::vector<std::string> threads = {"20"};
// int times = 1;
...
// Query 1 直接run原模型
std::string queryOriginalModel = "SELECT * FROM table1 where "
                                 "onnx('./../../../data/model/house_16H_d5_l25_n49_20240905072107.onnx', "
                                 "P1, P5p1, P6p2, P11p4, P14p9, P15p1, P15p3, "
                                 "P16p2, P18p2, P27p4, H2p2, H8p2, H10p1, H13p1, H18pA,H40p4) ?;";

// Query 2 开启优化
std::string queryWithRules = "SELECT * FROM table1 where "
                             "onnx('./../../../data/model/house_16H_d5_l25_n49_20240905072107.onnx', "
                             "P1, P5p1, P6p2, P11p4, P14p9, P15p1, P15p3, "
                             "P16p2, P18p2, P27p4, H2p2, H8p2, H10p1, H13p1, H18pA,H40p4) ?;";
...
void testOriginalModel() {
	...
	std::ofstream file("testOriginalModelOutput7.csv");
...
void testUnusedColumnsRemoved() {
	...
	std::ofstream file("testUnusedColumnsRemovedOutput.csv");
