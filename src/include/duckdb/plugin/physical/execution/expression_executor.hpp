...
//                         DuckDB
//
// duckdb/plugin/physical/execution/expression_executor.hpp
//
//
//===----------------------------------------------------------------------===//
...
protected:
	...
	static unique_ptr<ExpressionState> InitializeState(const BoundParameterExpression &expr,
	                                                   ExpressionExecutorState &state);
	// Todo												   
	static unique_ptr<ExpressionState> InitializeState(const BoundOnnxExpression &expr,
	                                                   ExpressionExecutorState &state);
	...
	void Execute(const BoundReferenceExpression &expr, ExpressionState *state, const SelectionVector *sel, idx_t count,
	             Vector &result);
	// TODO
	void Execute(const BoundOnnxExpression &expr, ExpressionState *state, const SelectionVector *sel, idx_t count,
	             Vector &result);
